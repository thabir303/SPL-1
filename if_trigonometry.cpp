...
string if_trigonometry(string equ)
{
    ...
    bool trigono_track_trigono=trigonometry_function(trigonometry_chain);
    bool trigono_track_ln=ln_function(trigonometry_chain);
    bool trigono_track_exp=exp_function(trigonometry_chain);

/*
   if(k!=1 && trigono_track_trigono==false )
   {
       if(all_t>0)
       {
           int tx,ty=0;
   ...
   else if(k==1 && trigono_track_trigono==false)
   {
       if(trigono_var=='\0')
       {
         ans7="0";
   ...
   else if(trigono_track_trigono==true)
   {
       if(all_t>0)
       {
           all_trigon();
       ...
       if(k==1)
        {
           ...
           {
               if(trigonometry_chain[i]=='(' && trigonometry_chain[i+1]==')')
                {
                    trigonometry_chain[0] = '(';
                    trigonometry_chain[1] = trigono_var;
                    trigonometry_chain[2] = ')';
       ...
       anstt+=if_trigonometry(trigonometry_chain);
       ans7+=anstt;
       if(all_t>0)
       {
           cout<<anstt;
 ...
 //
   ...
   else if( k != 1 && trigono_track_trigono==true)
    {
            ans7+=if_trigonometry(trigonometry_chain);
